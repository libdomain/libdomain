...
samba-tool computer create test_rename_c --description="Test computer rename" -k yes
samba-tool computer create test_mod_c --description="Test computer modification" -k yes
samba-tool computer create test_delete_c --description="Test computer delete" -k yes
